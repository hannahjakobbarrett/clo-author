...
Participants will be recruited from YouGov's Danish online panel. The target sample is (xxxx) voting-eligible adults (age 18 and above), allocated equally across treatment conditions (xxx per condition). Respondents who fail attention checks will be excluded from the analytical sample prior to hypothesis testing; target cell sizes refer to the post-exclusion sample.
